...
page_heading_title: When Bird Flocks Become Flying Formations
source_count: 35
infographic_count: 3
planned_sections:
- V shapes, lines and clustered lights
- Banking, flashing and apparent rotation
...
image: /assets/images/ifos_-_causes_of_UFO_3ed238_birds_ufo_reports_1b9c40_migrating_flocks_str_882181-Illustration-1-social.jpg
---
...
* A V-shaped flock can resemble a giant chevron or triangular craft.
* Birds flying in a long echelon may appear as a row of evenly spaced lights.
* Dense clusters can merge visually into a single luminous mass.
* Mixed-species flocks may create irregular but apparently purposeful geometric patterns.
* Large flocks can change shape while maintaining a common direction, giving the impression of an intelligently controlled object. <span class="citation-link-wrap"><a class="citation-inline-link" href="https://en.wikipedia.org/wiki/Delta_formation" target="_blank" rel="noopener noreferrer nofollow" aria-label="View source: Wikipedia">[Wikipedia]</a><span class="citation-popover" role="note"><span class="citation-popover-source">Wikipedia</span><span class="citation-popover-title">Delta formation</span><span class="citation-popover-snippet">Delta formation</span></span></span>
...
## Why Banking Birds Seem to Flash or Rotate
...
* A craft revealing illuminated surfaces.
* Objects merging into one body.
* A formation breaking apart and reforming.
...
Night migration is particularly important in the UFO context because many witnesses are unaware of how much bird traffic occurs overhead after dark. Large numbers of species migrate primarily at night, often at substantial altitudes and far beyond the [range]({{ 'range/' | relative_url }}) at which individual birds can be recognised. <span class="citation-chip-wrap"><a class="citation-chip" href="https://birdlifemalta.org/2020/04/listening-to-the-sky-the-fascinating-world-of-nocmigging/" target="_blank" rel="noopener noreferrer nofollow" aria-label="View source: birdlifemalta.org">[BirdLife Malta]</a><span class="citation-popover" role="note"><span class="citation-popover-source">birdlifemalta.org</span><span class="citation-popover-snippet">BirdLife MaltaListening to the sky, the fascinating world of nocmiggingApril 20, 2020 — 20 Apr 2020 — Migrating at night helps birds avoi...</span><span class="citation-popover-meta">Published: April 20, 2020</span></span></span> DarkSky Radar studies transformed scientific understanding of this phenomenon. In the 1950s <span class="citation-chip-wrap"><a class="citation-chip" href="https://darksky.org/news/what-you-should-know-about-bird-migration-and-light-pollution/" target="_blank" rel="noopener noreferrer nofollow" aria-label="View source: darksky.org">[darksky.org]</a><span class="citation-popover" role="note"><span class="citation-popover-source">darksky.org</span><span class="citation-popover-title">what you should know about bird migration and light pollution</span><span class="citation-popover-snippet">DarkSky InternationalWhat You Should Know About Bird Migration and Light...14 Sept 2020 — Artificial light at night (ALAN) can disrupt b...</span></span></span>, some unidentified [radar]({{ 'radar/' | relative_url }}) targets were eventually recognised as migrating birds rather than unknown aircraft, helping establish modern radar ornithology. <span class="citation-chip-wrap"><a class="citation-chip" href="https://www.calacademy.org/explore-science/radar-tracks-migrating-birds" target="_blank" rel="noopener noreferrer nofollow" aria-label="View source: calacademy.org">[California Academy of Sciences]</a><span class="citation-popover" role="note"><span class="citation-popover-source">calacademy.org</span><span class="citation-popover-title">radar tracks migrating birds</span><span class="citation-popover-snippet">California Academy of SciencesRadar Tracks Migrating Birds21 Dec 2016 — In the 1950s, U.S. radar stations picked up unidentified flying o...</span></span></span>

Night migration creates several pathways to UFO reports:
...
### Dispersed Yet Coordinated Movement

Research indicates that some nocturnal migrants travel in loose associations rather than as tightly packed groups. Birds separated by hundreds of metres may still move in the same direction and maintain coordinated behaviour. To an observer on the ground, these scattered lights can appear as a deliberate formation of unknown craft. <span class="citation-chip-wrap"><a class="citation-chip" href="https://news.illinois.edu/birds-migrate-together-at-night-in-dispersed-flocks-new-study-indicates/" target="_blank" rel="noopener noreferrer nofollow" aria-label="View source: news.illinois.edu">[Illinois News]</a><span class="citation-popover" role="note"><span class="citation-popover-source">news.illinois.edu</span><span class="citation-popover-title">Some birds, at least, keep together on their migratory journeys.Read more</span><span class="citation-popover-snippet">Illinois NewsBirds migrate together at night in dispersed flocks, new study...7 Jul 2008 — A new analysis indicates that birds don&#x27;t fly...</span></span></span>
...
<section class="further-reading-section" data-page-toc-exclude aria-labelledby="further-reading-title">
  <div class="fr-section-shell">
    <div class="fr-section-header">
      ...
      <p class="fr-intro">Books and field guides related to When Bird Flocks Become Flying Formations. Use these as the next step if you want deeper reading beyond the article.</p>
    </div>
    <div class="fr-books-grid">

    <article class="fr-book-card">
      <a class="fr-book-cover" href="https://www.amazon.com/s?k=The+Sibley+guide+to+birds&amp;i=stripbooks&amp;tag=searcht-20" target="_blank" rel="sponsored noopener noreferrer" aria-label="Open The Sibley guide to birds on Amazon"><span class="fr-book-cover-fallback">Book</span><img class="fr-book-cover-thumb" src="https://covers.openlibrary.org/b/id/12756810-M.jpg" alt="Cover for The Sibley guide to birds" loading="lazy" decoding="async" fetchpriority="low" referrerpolicy="no-referrer" onerror="this.hidden=true;this.closest('.fr-book-cover').classList.add('fr-book-cover-placeholder');"></a>
      <div class="fr-book-info">
        <h4 class="fr-book-title">
          <a href="https://www.amazon.com/s?k=The+Sibley+guide+to+birds&amp;i=stripbooks&amp;tag=searcht-20" target="_blank" rel="sponsored noopener noreferrer" title="The Sibley guide to birds">The Sibley guide to birds</a>
        </h4>
        <p class="fr-book-author">By Unknown author</p>
        
        <p class="fr-book-desc">Directly supports understanding flock structure, silhouettes and migration behaviour.</p>
        <div class="fr-book-actions">
          <a href="https://www.amazon.com/s?k=The+Sibley+guide+to+birds&amp;i=stripbooks&amp;tag=searcht-20" class="fr-amazon-btn" target="_blank" rel="sponsored noopener noreferrer">
            See on Amazon
          </a>
        </div>
      </div>
    ...
    <article class="fr-book-card">
      ...
      <div class="fr-book-info">
        ...
        <p class="fr-book-desc">Useful for evaluating dramatic sightings without jumping to conclusions.</p>
        <div class="fr-book-actions">
    ...
    <article class="fr-book-card">
      ...
      <div class="fr-book-info">
        ...
        <p class="fr-book-desc">Provides broader context for assessing multiple-witness and formation reports.</p>
        <div class="fr-book-actions">
