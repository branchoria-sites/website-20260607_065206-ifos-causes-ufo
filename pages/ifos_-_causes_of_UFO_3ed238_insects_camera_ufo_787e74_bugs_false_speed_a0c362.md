...
page_heading_title: Why Bugs Can Look Impossibly Fast
source_count: 47
infographic_count: 3
planned_sections:
...
image: /assets/images/ifos_-_causes_of_UFO_3ed238_insects_camera_ufo_787e74_bugs_false_speed_a0c362-Illustration-1-social.jpg
---
...
Imagine an insect 10 centimetres from a camera lens. It moves 20 centimetres sideways in half a second. To the camera, that motion can produce a large sweep across the frame.
...
The key mechanism is angular motion. Cameras record angles rather than true distances. When a nearby object crosses the field of view, its angular position can change very rapidly.

A useful everyday comparison is looking out of a moving train. Fence posts close to the track appear to race past, while distant hills seem almost stationary. The nearby objects are not actually moving faster than the hills; their apparent speed is greater because of geometry.
...
* Shooting across the frame in a fraction of a second.
* Instantly changing direction.
* Accelerating beyond known aircraft capabilities.
* Appearing and disappearing with impossible timing.
...
Distance errors do not merely introduce small inaccuracies. They can alter conclusions by orders of magnitude.
...
1. An object appears unusually fast.
2. The object's distance is assumed rather than measured.
3. Large speeds are calculated from that assumption.
4. A near-camera explanation removes the need for extraordinary motion.
...
When a video appears to show impossible velocity, several questions can help determine whether a nearby insect is a plausible explanation.

**Has the distance been measured?**

If there is no independent range measurement, any speed estimate is provisional.
...
Interaction with clouds, buildings or terrain can help constrain distance. Objects floating against an empty sky provide fewer clues.

**Is the object out of focus?**

A blurred shape may indicate something passing close to a lens focused on distant scenery.

**Does the motion resemble angular sweep rather than sustained flight?**

Many near-lens insects cross the frame rapidly without showing the consistent trajectory expected of a distant aircraft.

**Are extreme speeds based entirely on assumed altitude or range?**
