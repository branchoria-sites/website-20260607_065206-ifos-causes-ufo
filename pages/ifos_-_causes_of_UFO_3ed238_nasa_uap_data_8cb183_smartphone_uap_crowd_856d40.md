...
page_heading_title: Could phones make UFO reports scientific?
source_count: 48
infographic_count: 3
planned_sections:
- Why one phone clip is usually weak evidence
- How synchronized observations could improve a case
- The privacy and quality problems crowdsourcing must solve
...
image: /assets/images/ifos_-_causes_of_UFO_3ed238_nasa_uap_data_8cb183_smartphone_uap_crowd_856d40-Illustration-1-social.jpg
---
...
Most UFO reports begin with a familiar problem: one witness records a short video of an unfamiliar object. Even when the witness is sincere, investigators often cannot determine the object's distance, altitude, size or speed from a single viewpoint.

A bright light filmed against a dark sky illustrates the difficulty. Without independent reference points, a distant aircraft, a satellite, a drone, a balloon or an unusual atmospheric effect can appear surprisingly similar on a phone screen. Small camera movements can also create the illusion of dramatic motion. NASA's UAP study highlighted recurring weaknesses in available evidence, including [missing metadata]({{ 'missing-metadata/' | relative_url }}), lack of calibration and the absence of multiple measurements.<span class="citation-chip-wrap"><a class="citation-chip" href="https://science.nasa.gov/wp-content/uploads/2023/09/uap-independent-study-team-final-report.pdf" target="_blank" rel="noopener noreferrer nofollow" aria-label="View source: science.nasa.gov">[NASA Science]</a><span class="citation-popover" role="note"><span class="citation-popover-source">science.nasa.gov</span><span class="citation-popover-snippet">NASA ScienceIndependent Study Team ReportThe panel sees several advantages to augmenting data collection efforts using modern crowdsourci...</span></span></span>

Phone footage also loses context when shared through social media. [Compression]({{ 'compression/' | relative_url }}) may remove technical information, while reposts often separate the video from its original time, location and recording conditions. As a result, investigators are frequently left with imagery but little reliable information about the circumstances of the observation.<span class="citation-chip-wrap"><a class="citation-chip" href="https://science.nasa.gov/wp-content/uploads/2023/09/uap-independent-study-team-final-report.pdf" target="_blank" rel="noopener noreferrer nofollow" aria-label="View source: science.nasa.gov">[NASA Science]</a><span class="citation-popover" role="note"><span class="citation-popover-source">science.nasa.gov</span><span class="citation-popover-snippet">NASA ScienceIndependent Study Team ReportThe panel sees several advantages to augmenting data collection efforts using modern crowdsourci...</span></span></span>

The weakness of many UFO videos therefore stems less from image quality than from missing supporting data. A sharper clip helps, but a well-documented observation is often more valuable than a visually impressive one.
...
Crowdsourced observations can also establish a more reliable chronology.

If dozens of reports arrive from different locations, investigators can determine whether people observed the same event or separate events. Time synchronisation helps distinguish a single object moving across a region from unrelated sightings occurring on the same evening. This can be especially useful when evaluating reports of [satellites]({{ 'satellites/' | relative_url }}), rocket launches, re-entry events or other known aerospace activities.

### Creating statistical baselines

Another benefit is scale. Most UFO databases contain reports submitted in inconsistent formats. A structured smartphone network could collect observations using the same fields and standards every time.
...
A crowdsourced UAP network is not merely a technical project. It is also a governance challenge.

Collecting observations from large numbers of people requires rules about data quality, access, transparency and accountability. Without those rules, a smartphone network could generate vast quantities of unreliable information.
...
* Who verifies submitted reports?
* Which metadata are required?
* How are reports classified?
* How are false or manipulated submissions handled?
...
The same metadata that make observations useful can also create privacy concerns.

Precise location information may reveal where a person lives, works or travels. Time stamps and device information can create additional identification risks. Any large-scale reporting system would therefore need clear rules for anonymisation, consent and data protection before widespread public participation could be expected.<span class="citation-chip-wrap"><a class="citation-chip" href="https://science.nasa.gov/wp-content/uploads/2023/09/uap-independent-study-team-final-report.pdf" target="_blank" rel="noopener noreferrer nofollow" aria-label="View source: science.nasa.gov">[NASA Science]</a><span class="citation-popover" role="note"><span class="citation-popover-source">science.nasa.gov</span><span class="citation-popover-snippet">NASA ScienceIndependent Study Team ReportThe panel sees several advantages to augmenting data collection efforts using modern crowdsourci...</span></span></span>

Quality control presents an equally difficult challenge.

### Misidentifications at scale
...
Modern image-editing tools introduce another complication. Photos and videos can be altered, mislabelled or taken out of context.

A well-designed reporting system would therefore place significant value on [original files]({{ 'original-files/' | relative_url }}) and embedded metadata rather than relying on reposted social-media content. Verification mechanisms, audit trails and independent corroboration become increasingly important as image-generation technology improves.

### Selection bias

Crowdsourced systems also suffer from uneven participation. Reports tend to cluster around populated areas, media events and periods of heightened public attention. A spike in reports does not necessarily indicate a spike in unusual phenomena; it may simply reflect increased reporting behaviour.

Understanding these biases is essential if crowdsourced data are to support scientific analysis rather than amplify public excitement.

## From anecdotes to measurable observations
...
<section class="further-reading-section" data-page-toc-exclude aria-labelledby="further-reading-title">
  <div class="fr-section-shell">
    <div class="fr-section-header">
      ...
      <p class="fr-intro">Books and field guides related to Could phones make UFO reports scientific?. Use these as the next step if you want deeper reading beyond the article.</p>
    </div>
    ...
    <article class="fr-book-card">
      ...
      <div class="fr-book-info">
        ...
        <p class="fr-book-desc">Highlights the need for corroboration and multiple sources.</p>
    ...
    <article class="fr-book-card">
      ...
      <div class="fr-book-info">
        ...
        <p class="fr-book-desc">Focuses on collecting and assessing reports.</p>
        <div class="fr-book-actions">
    ...
    <article class="fr-book-card">
      ...
      <div class="fr-book-info">
        ...
        <p class="fr-book-desc">Shows how large-scale data collection can reveal patterns.</p>
        <div class="fr-book-actions">
    ...
    <article class="fr-book-card">
      ...
      <div class="fr-book-info">
        ...
        <p class="fr-book-desc">Relevant to extracting reliable signals from large datasets.</p>
        <div class="fr-book-actions">
