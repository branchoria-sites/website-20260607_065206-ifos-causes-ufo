...
page_heading_title: Why UFO Images Need Original Files
source_count: 42
infographic_count: 3
planned_sections:
...
image: /assets/images/ifos_-_causes_of_UFO_3ed238_ufo_hoaxes_c16965_missing_original_fil_0f5b6f-Illustration-1-social.jpg
---
...
* The claimed date and location become harder to verify.
* Investigators cannot determine whether the file has been edited.
* [Compression]({{ 'compression/' | relative_url }}) artefacts may create shapes, lights or distortions that were not present in the original.
* Reverse-image searches become more difficult when images have been cropped or altered.
...
Modern cameras and smartphones often embed Exchangeable Image File Format (EXIF) data inside image files. Depending on the device and settings, metadata may include:
...
A light in the sky may appear mysterious until investigators learn it was photographed near an airport approach path. A glowing object may resemble an unknown craft until the original image reveals camera settings consistent with a bright planet or a long-exposure effect. A cropped frame may hide nearby buildings, aircraft navigation lights or [reflections]({{ 'reflections/' | relative_url }}) that would immediately suggest a conventional explanation.
...
2. Can the photographer be identified and contacted?
3. Does the file contain metadata consistent with the claim?
4. Is there a documented upload history?
5. Has the image been cropped, filtered or repeatedly recompressed?
6. Can the location and time be independently verified?
7. Are there additional photographs, witnesses or sensor records?
...
<section class="further-reading-section" data-page-toc-exclude aria-labelledby="further-reading-title">
  <div class="fr-section-shell">
    <div class="fr-section-header">
      ...
      <p class="fr-intro">Books and field guides related to Why UFO Images Need Original Files. Use these as the next step if you want deeper reading beyond the article.</p>
    </div>
    ...
    <article class="fr-book-card">
      ...
      <div class="fr-book-info">
        ...
        <p class="fr-book-desc">Places photographic evidence within broader UFO investigation methods.</p>
    ...
    <article class="fr-book-card">
      ...
      <div class="fr-book-info">
        ...
        <p class="fr-book-desc">Provides insight into how images can misrepresent reality.</p>
        <div class="fr-book-actions">
    ...
    <article class="fr-book-card">
      ...
      <div class="fr-book-info">
        ...
        <p class="fr-book-desc">Helps readers understand source files, image quality and digital workflows.</p>
        <div class="fr-book-actions">
    ...
    <article class="fr-book-card">
      ...
      <div class="fr-book-info">
        ...
        <p class="fr-book-desc">Emphasizes evidence quality, provenance and verification.</p>
        <div class="fr-book-actions">
