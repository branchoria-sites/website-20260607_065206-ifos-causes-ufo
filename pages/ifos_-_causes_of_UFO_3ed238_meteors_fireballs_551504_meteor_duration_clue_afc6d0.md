...
page_heading_title: Was that flash too fast to be a craft?
source_count: 56
infographic_count: 3
planned_sections:
- Why natural meteors usually vanish in seconds
- How viewing angle can distort apparent speed
- When duration alone is not enough
...
image: /assets/images/ifos_-_causes_of_UFO_3ed238_meteors_fireballs_551504_meteor_duration_clue_afc6d0-Illustration-1-social.jpg
---
...
Fireballs are exceptionally bright meteors created when natural material enters Earth's [atmosphere]({{ 'atmosphere/' | relative_url }}) at extremely high speed. Because meteoroids typically strike the atmosphere far faster than aircraft or orbiting [satellites]({{ 'satellites/' | relative_url }}) move across the sky, their visible flight is usually brief. The American Meteor Society notes that the majority of fireballs last only a few seconds. Its reporting guidance even warns observers that sightings lasting more than about 30 seconds are unlikely to be typical fireballs. <span class="citation-chip-wrap"><a class="citation-chip" href="https://scistarter.org/american-meteor-society-meteor-observing" target="_blank" rel="noopener noreferrer nofollow" aria-label="View source: scistarter.org">[American Meteor Society]</a><span class="citation-popover" role="note"><span class="citation-popover-source">scistarter.org</span><span class="citation-popover-snippet">Meteor observingJoin the American Meteor Society community and contribute valuable and precise data relating to meteor shower and firebal...</span></span></span>

This short duration repeatedly appears in documented events. A major fireball analysed by the European Space Agency over Europe in March 2026 glowed for roughly six seconds before fragmenting. Another well-studied Ohio fireball in 2026 produced a bright flash that lasted up to seven seconds despite involving a sizeable incoming object. <span class="citation-chip-wrap"><a class="citation-chip" href="https://www.esa.int/Space_Safety/Planetary_Defence/ESA_analysing_fireball_over_Europe_on_8_March_2026" target="_blank" rel="noopener noreferrer nofollow" aria-label="View source: esa.int">[European Space Agency]</a><span class="citation-popover" role="note"><span class="citation-popover-source">esa.int</span><span class="citation-popover-title">The event was recorded by many dedicated</span><span class="citation-popover-snippet">European Space AgencyESA analysing fireball over Europe on 8 March 2026The fireball glowed for approximately six seconds, leaving a visib...</span></span></span>

For a witness, that means a report such as:

* “A brilliant green-white streak crossed half the sky and vanished in three seconds.”
* “There was a sudden flash, a bright trail and then nothing.”
...
Duration is helpful because apparent speed can be deceptive.

A fireball moving almost directly toward an observer may appear slower than one crossing the observer's field of view from side to side. The same atmospheric event can therefore generate conflicting descriptions. One witness may report an impossibly fast streak, while another describes a slower-moving glowing object.
...
One reason duration is valuable in UFO investigations is that some alternative explanations remain visible much longer.

The Aerospace Corporation, which studies orbital re-entries, gives a practical distinction: natural [meteors]({{ 'meteors/' | relative_url }}) typically last less than a few seconds, while human-made re-entries often remain visible for 20 to 90 seconds or even longer. Other space-observation guides give similar descriptions, noting that re-entering debris is normally visible for well over ten seconds because it enters the atmosphere at lower speeds than natural meteors. <span class="citation-chip-wrap"><a class="citation-chip" href="https://aerospace.org/article/what-does-reentry-look-like" target="_blank" rel="noopener noreferrer nofollow" aria-label="View source: aerospace.org">[The Aerospace Corporation]</a><span class="citation-popover" role="note"><span class="citation-popover-source">aerospace.org</span><span class="citation-popover-snippet">The Aerospace CorporationWhat Does a Reentry Look LikeThe general rule-of-thumb is that natural meteor reentries happen quickly and typic...</span></span></span> <span class="citation-chip-wrap"><a class="citation-chip" href="https://www.spaceacademy.net.au/watch/debris/reentryhaz.htm" target="_blank" rel="noopener noreferrer nofollow" aria-label="View source: spaceacademy.net.au">[Space Academy]</a><span class="citation-popover" role="note"><span class="citation-popover-source">spaceacademy.net.au</span><span class="citation-popover-snippet">Hazards of Reentering Space DebrisBecause a debris reentry has a lower velocity than a meteor/fireball it will be visible for longer - no...</span></span></span>

That difference produces a recognisable contrast:

ObservationMore consistent withBright streak visible for 1–5 secondsFireball meteorBright event lasting roughly 5–10 secondsPossible fireball, especially a slow or large oneMultiple glowing fragments drifting for 20–90+ secondsRe-entering spacecraft or rocket debrisSteady light crossing the sky for several minutesSatellite or aircraft
...
Duration is a strong clue, not a final verdict.

Several factors can complicate the picture:

* **Persistent trains:** A fireball may disappear after a few seconds but leave a glowing trail that remains visible for much longer. The meteor's flight was brief even though the trail lingered. <span class="citation-chip-wrap"><a class="citation-chip" href="https://scistarter.org/american-meteor-society-meteor-observing" target="_blank" rel="noopener noreferrer nofollow" aria-label="View source: scistarter.org">[American Meteor Society]</a><span class="citation-popover" role="note"><span class="citation-popover-source">scistarter.org</span><span class="citation-popover-snippet">Meteor observingJoin the American Meteor Society community and contribute valuable and precise data relating to meteor shower and firebal...</span></span></span>
* **Fragmentation:** A fireball can break into multiple pieces near the end of its flight, making witnesses think they are seeing several separate objects. <span class="citation-chip-wrap"><a class="citation-chip" href="https://www.esa.int/Space_Safety/Planetary_Defence/ESA_analysing_fireball_over_Europe_on_8_March_2026" target="_blank" rel="noopener noreferrer nofollow" aria-label="View source: esa.int">[European Space Agency]</a><span class="citation-popover" role="note"><span class="citation-popover-source">esa.int</span><span class="citation-popover-title">The event was recorded by many dedicated</span><span class="citation-popover-snippet">European Space AgencyESA analysing fireball over Europe on 8 March 2026The fireball glowed for approximately six seconds, leaving a visib...</span></span></span>
* **Poor time estimates:** People commonly overestimate the length of dramatic events, especially unexpected flashes in the night sky. <span class="citation-chip-wrap"><a class="citation-chip" href="https://www.popastro.com/meteor/detailed-fireball-reporting-guide/" target="_blank" rel="noopener noreferrer nofollow" aria-label="View source: popastro.com">[Popular Astronomy]</a><span class="citation-popover" role="note"><span class="citation-popover-source">popastro.com</span><span class="citation-popover-title">Popular Astronomy Detailed Fireball Reporting Guide</span><span class="citation-popover-snippet">Popular AstronomyDetailed Fireball Reporting Guide - Meteor SectionVery few fireballs last more than 5 or 10 seconds, and only man-made r...</span></span></span>
...
<section class="further-reading-section" data-page-toc-exclude aria-labelledby="further-reading-title">
  <div class="fr-section-shell">
    <div class="fr-section-header">
      ...
      <p class="fr-intro">Books and field guides related to Was that flash too fast to be a craft?. Use these as the next step if you want deeper reading beyond the article.</p>
    </div>
    ...
    <article class="fr-book-card">
      ...
      <div class="fr-book-info">
        ...
        <p class="fr-book-desc">Useful for separating meteors from longer-lasting UFO reports.</p>
    ...
    <article class="fr-book-card">
      ...
      <div class="fr-book-info">
        ...
        <p class="fr-book-desc">Strong practical fit for recognising brief sky events.</p>
        <div class="fr-book-actions">
    ...
    <article class="fr-book-card">
      ...
      <div class="fr-book-info">
        ...
        <p class="fr-book-desc">Helps readers understand observational clues and timing.</p>
        <div class="fr-book-actions">
    ...
    <article class="fr-book-card">
      ...
      <div class="fr-book-info">
        ...
        <p class="fr-book-desc">Explains fireballs and meteorite-producing events.</p>
        <div class="fr-book-actions">
