...
- ifos_-_causes_of_UFO_3ed238_sensor_operators_e2e57b_index
...
page_heading_title: When Sensors Need Human Context
source_count: 98
infographic_count: 3
planned_sections:
- Operator perception
- Calibration and range
- Combining sensors and witnesses
...
image: /assets/images/ifos_-_causes_of_UFO_3ed238_sensor_operators_e2e57b-overview-social.jpg
---
...
* **Time and location:** the exact timestamp, platform position and viewing direction.
* **Range and geometry:** target distance, sensor angle, aircraft movement and field of view.
* **Environmental data:** wind, temperature layers, haze, cloud, sea state and atmospheric refraction.
* **Traffic and object databases:** aircraft tracks, drone operations, balloon launches, [satellites]({{ 'satellites/' | relative_url }}) and known exercises.
* **Independent sensors:** radar plus infrared, visual plus ADS-B, multiple cameras, or ground and airborne views.
* **Raw or minimally processed data:** original files, metadata and longer clips rather than short compressed excerpts.
  ...
  <div class="fr-section-shell">
    ...
    <article class="fr-book-card">
      ...
      <div class="fr-book-info">
        ...
        <p class="fr-book-desc">Focuses on evidence evaluation and scientific skepticism.</p>
