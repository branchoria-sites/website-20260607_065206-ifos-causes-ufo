...
page_heading_title: Why Wind Farms Can Confuse Airport Radar
source_count: 39
infographic_count: 3
planned_sections:
- How turbine blades reflect radar energy
- False tracks, masking, and track seduction
...
image: /assets/images/ifos_-_causes_of_UFO_3ed238_radar_anomalies_d7d357_wind_turbine_radar_f_17eb42-Illustration-1-social.jpg
---
...
The problem becomes more severe because the blades rotate. When radar energy reflects from a moving object, the return experiences a Doppler frequency shift. Air-surveillance radars often use Doppler processing to distinguish moving aircraft from stationary terrain. A rotating blade can therefore generate the kind of frequency shift that radar software normally associates with a moving target. Technical assessments prepared for aviation authorities and wind-farm planning reviews explain that rotating blades can trigger radar Doppler thresholds and may consequently be interpreted as aircraft-like returns. <span class="citation-chip-wrap"><a class="citation-chip" href="https://ossian-eia.com/offshore-eia/vol3/ap14-1-aviation-military-and-communications-technical-report/" target="_blank" rel="noopener noreferrer nofollow" aria-label="View source: ossian-eia.com">[Ossian EIA]</a><span class="citation-popover" role="note"><span class="citation-popover-source">ossian-eia.com</span><span class="citation-popover-title">Ossian EIA2. Study Area</span><span class="citation-popover-snippet">wind turbine that is detectable by a PSR system can be a significant cause of radar false plots, or unwanted returns (clutter), as the ro...</span></span></span>

Researchers studying turbine effects on radar have noted that blade-tip speeds can be surprisingly high. Depending on turbine size and operating conditions, blade tips may reach velocities comparable to those of small aircraft. One technical assessment calculated blade-tip speeds exceeding 280 km/h, sufficient to generate substantial Doppler signatures on surveillance radar. <span class="citation-chip-wrap"><a class="citation-chip" href="https://fenix.tecnico.ulisboa.pt/downloadFile/395146018644/Extended_Abstract.pdf" target="_blank" rel="noopener noreferrer nofollow" aria-label="View source: fenix.tecnico.ulisboa.pt">[Fenix Técnico Lisboa]</a><span class="citation-popover" role="note"><span class="citation-popover-source">fenix.tecnico.ulisboa.pt</span><span class="citation-popover-title">Finally, one defines</span><span class="citation-popover-snippet">Fenix Técnico LisboaAssessment of Wind Turbines Generators Influence in...December 2, 2013 — The Doppler shift could generate false targ...</span><span class="citation-popover-meta">Published: December 2, 2013</span></span></span>

Unlike ordinary buildings or terrain features, turbines therefore appear to radar as both a large reflector and a moving object simultaneously. This combination makes them unusually difficult to filter out.

## False Tracks, Masking, and Track Seduction

Radar interference from wind farms generally falls into three categories that are particularly relevant to UFO-style radar reports.

### False Plots and False Targets

The most direct effect is the generation of false radar plots. A radar display may show returns that appear to represent moving airborne objects even though the source is a turbine.

The International Energy Agency's expert review of wind-turbine radar interactions notes that rotating blades can create intermittent clutter capable of generating false tracks. Technical reports prepared for aviation impact assessments similarly describe turbines as potential sources of false plots on primary surveillance radar systems. <span class="citation-chip-wrap"><a class="citation-chip" href="https://iea-wind.org/wp-content/uploads/2023/10/83_Mitigation-of-WT-impacts-on-radar.pdf" target="_blank" rel="noopener noreferrer nofollow" aria-label="View source: iea-wind.org">[IEA Wind TCP]</a><span class="citation-popover" role="note"><span class="citation-popover-source">iea-wind.org</span><span class="citation-popover-snippet">nd the intermittent clutter can create false tracks, obscure or seduce real...</span></span></span>

In air-traffic-control environments, these false plots can appear as isolated targets or short-lived tracks. Wind-energy industry publications have documented cases where turbine clutter generated apparent aircraft targets, creating additional workload for controllers and sometimes requiring operational adjustments. <span class="citation-chip-wrap"><a class="citation-chip" href="https://www.windtech-international.com/contacts/avoiding-false-radar-returns" target="_blank" rel="noopener noreferrer nofollow" aria-label="View source: windtech-international.com">[windtech-international.com]</a><span class="citation-popover" role="note"><span class="citation-popover-source">windtech-international.com</span><span class="citation-popover-title">avoiding false radar returns</span><span class="citation-popover-snippet">10 Sept 2010 — Sophisticated signal processing and tracking algorithms will be applied at the radar to eliminate the wind turbine blades...</span></span></span>
...
Wind farms can also hide genuine targets.

Radar systems must detect aircraft against a background of [reflections]({{ 'reflections/' | relative_url }}). When a wind farm produces strong clutter, a legitimate aircraft flying near or behind the turbines may become harder to distinguish. The Department of Energy, MIT Lincoln Laboratory, and multiple aviation studies have all identified reduced target detectability as a major consequence of turbine interference. <span class="citation-chip-wrap"><a class="citation-chip" href="https://www.ll.mit.edu/r-d/projects/wind-turbine-interference-mitigation-study" target="_blank" rel="noopener noreferrer nofollow" aria-label="View source: ll.mit.edu">[Lincoln Laboratory]</a><span class="citation-popover" role="note"><span class="citation-popover-source">ll.mit.edu</span><span class="citation-popover-snippet">Lincoln LaboratoryWind Turbine Interference–Mitigation StudyWind turbines are highly visible to radars, and the interference that turbine...</span></span></span> <span class="citation-chip-wrap"><a class="citation-chip" href="https://www.energy.gov/cmei/systems/windexchange/radar-interference" target="_blank" rel="noopener noreferrer nofollow" aria-label="View source: energy.gov">[The Department of Energy&#x27;s Energy.gov]</a><span class="citation-popover" role="note"><span class="citation-popover-source">energy.gov</span><span class="citation-popover-snippet">The Department of Energy&#x27;s Energy.govRadar Interference2 days ago — Wind turbines—land-based, distributed, and offshore—can interfere wit...</span></span></span>

This effect can create a puzzling situation in which a real aircraft appears intermittently or disappears from radar coverage. To an observer unfamiliar with local turbine effects, such behaviour may seem anomalous.

### Track Seduction and Track Corruption

More sophisticated radar systems use software that links individual plots into tracks. These tracking algorithms attempt to predict where a target should appear on subsequent scans.
...
The problem gained prominence because turbine technology evolved faster than many radar networks.

Early wind turbines were relatively small. Modern turbines are far larger, often occupying elevated locations that are also attractive sites for radar coverage. As wind-energy development expanded, conflicts with radar operators became increasingly common.

The UK's Civil Aviation Authority produced dedicated guidance on wind-turbine impacts because of the recurring interaction between wind-energy projects and aviation systems. CAP 764 specifically exists to help stakeholders assess and manage aviation impacts associated with wind-energy developments. <span class="citation-chip-wrap"><a class="citation-chip" href="https://www.caa.co.uk/publication/download/14561" target="_blank" rel="noopener noreferrer nofollow" aria-label="View source: caa.co.uk">[Civil Aviation Authority]</a><span class="citation-popover" role="note"><span class="citation-popover-source">caa.co.uk</span><span class="citation-popover-title">Civil Aviation Authority CAP764 CAA Policy and Guidelines on Wind Turbines</span><span class="citation-popover-snippet">Civil Aviation AuthorityCAP764 CAA Policy and Guidelines on Wind TurbinesDecember 17, 2025 — 7 Dec 2025 — CAP 764 is published to assist...</span><span class="citation-popover-meta">Published: December 17, 2025</span></span></span>

In the United States, radar interference became sufficiently significant that federal agencies launched extensive research programmes. MIT Lincoln Laboratory, the Department of Energy, and other organisations studied mitigation methods because turbine interference was affecting surveillance performance. MIT Lincoln Laboratory concluded that wind turbines are highly visible to radar and can impede the detection and characterisation of genuine targets. <span class="citation-chip-wrap"><a class="citation-chip" href="https://www.ll.mit.edu/r-d/projects/wind-turbine-interference-mitigation-study" target="_blank" rel="noopener noreferrer nofollow" aria-label="View source: ll.mit.edu">[Lincoln Laboratory]</a><span class="citation-popover" role="note"><span class="citation-popover-source">ll.mit.edu</span><span class="citation-popover-snippet">Lincoln LaboratoryWind Turbine Interference–Mitigation StudyWind turbines are highly visible to radars, and the interference that turbine...</span></span></span>

The issue is not confined to air-traffic-control radar. Weather radar systems have experienced similar problems. NOAA's Radar Operations Center explains that wind turbines can appear in weather-radar products because their moving blades create radar signatures that contaminate meteorological observations. Research published in the American Meteorological Society literature similarly found that wind-turbine clutter can be difficult to distinguish from genuine weather echoes. <span class="citation-chip-wrap"><a class="citation-chip" href="https://www.roc.noaa.gov/windfarms/wf-impact.php" target="_blank" rel="noopener noreferrer nofollow" aria-label="View source: roc.noaa.gov">[roc.noaa.gov]</a><span class="citation-popover" role="note"><span class="citation-popover-source">roc.noaa.gov</span><span class="citation-popover-snippet">the added challenge of being almost constantly in...Read more...</span></span></span>
...
Real-world examples demonstrate that turbine interference is not merely a theoretical concern.

The U.S. National Weather Service has stated that the FAA has rerouted air traffic because of false returns produced by wind-turbine clutter. The agency notes that radar data used by controllers can be affected by turbine-generated echoes, requiring operational responses. <span class="citation-chip-wrap"><a class="citation-chip" href="https://www.weather.gov/roc/WindFarms" target="_blank" rel="noopener noreferrer nofollow" aria-label="View source: weather.gov">[Weather.gov]</a><span class="citation-popover" role="note"><span class="citation-popover-source">weather.gov</span><span class="citation-popover-snippet">WIND FARM INTERACTION WITH NEXRAD RADARThe FAA has re-routed air traffic due to false returns from wind turbine clutter. NEXRAD data stre...</span></span></span>

In Australia, observers reported persistent false precipitation signatures over the Murra Warra wind farm on Bureau of Meteorology radar displays. The radar repeatedly showed apparent rainfall where no precipitation existed, illustrating how turbine returns can generate convincing but erroneous radar imagery. <span class="citation-chip-wrap"><a class="citation-chip" href="https://www.heraldsun.com.au/news/victoria/murra-warra-wind-farm-interferes-with-bom-radar/news-story/4e6e1a5b9b81aecacf5a466ba3120b18" target="_blank" rel="noopener noreferrer nofollow" aria-label="View source: heraldsun.com.au">[Herald Sun]</a><span class="citation-popover" role="note"><span class="citation-popover-source">heraldsun.com.au</span><span class="citation-popover-title">Herald Sun Wind farm interfering with weather radar</span><span class="citation-popover-snippet">El radar de Rainbow mostró una zona de color azul parpadeante sobre las turbinas de Murra Warra, a pesar de que la lluvia más cercana est...</span></span></span>

RenewableUK's survey of aviation and defence impacts likewise notes that wind turbines can appear as false positives on radar systems and can make aircraft detection and tracking more difficult through radar desensitisation. <span class="citation-chip-wrap"><a class="citation-chip" href="https://www.renewableuk.com/media/tu2l2ta3/the-2023-survey-of-onshore-wind-impacts-on-aviation-and-defence-summary.pdf" target="_blank" rel="noopener noreferrer nofollow" aria-label="View source: renewableuk.com">[renewableuk.com]</a><span class="citation-popover" role="note"><span class="citation-popover-source">renewableuk.com</span><span class="citation-popover-snippet">13, 2025 — Wind turbines can show up as false positives on radar systems...</span><span class="citation-popover-meta">Published: June 13, 2025</span></span></span>
...
When an unidentified radar contact occurs near a wind farm, investigators should be cautious before treating the radar evidence as proof of an unknown craft.

The first question should be whether wind turbines existed within radar line of sight at the time of the event. This requires checking local infrastructure records, planning documents, aeronautical charts, and historical satellite imagery. A radar anomaly occurring near a turbine complex deserves a different evidential assessment than a similar anomaly occurring in an area free of major reflective structures.

Investigators should also determine the type of radar involved. Primary surveillance radar is generally more vulnerable to turbine-generated false plots because it relies on reflected energy alone. The precise impact depends on radar frequency, processing algorithms, turbine size, terrain, and geometry. <span class="citation-chip-wrap"><a class="citation-chip" href="https://ossian-eia.com/offshore-eia/vol3/ap14-1-aviation-military-and-communications-technical-report/" target="_blank" rel="noopener noreferrer nofollow" aria-label="View source: ossian-eia.com">[Ossian EIA]</a><span class="citation-popover" role="note"><span class="citation-popover-source">ossian-eia.com</span><span class="citation-popover-title">Ossian EIA2. Study Area</span><span class="citation-popover-snippet">wind turbine that is detectable by a PSR system can be a significant cause of radar false plots, or unwanted returns (clutter), as the ro...</span></span></span>

Equally important is whether the radar contact was independently confirmed. A genuine aircraft should normally generate corroborating evidence from transponders, secondary surveillance systems, visual observations, or multiple radar sites. A turbine-induced false target often lacks this broader evidential support.
...
<section class="further-reading-section" data-page-toc-exclude aria-labelledby="further-reading-title">
  <div class="fr-section-shell">
    <div class="fr-section-header">
      ...
      <p class="fr-intro">Books and field guides related to Why Wind Farms Can Confuse Airport Radar. Use these as the next step if you want deeper reading beyond the article.</p>
    </div>
    ...
    <article class="fr-book-card">
      <a class="fr-book-cover" href="https://www.amazon.com/s?k=Wind+Energy+Explained+J.+F.%2F+McGowan%2C+Jon%2F+Rogers%2C+An+Manwell&amp;i=stripbooks&amp;tag=searcht-20" target="_blank" rel="sponsored noopener noreferrer" aria-label="Open Wind Energy Explained on Amazon"><span class="fr-book-cover-fallback">Book</span><img class="fr-book-cover-thumb" src="https://covers.openlibrary.org/b/id/5050403-M.jpg" alt="Cover for Wind Energy Explained" loading="lazy" decoding="async" fetchpriority="low" referrerpolicy="no-referrer" onerror="this.hidden=true;this.closest('.fr-book-cover').classList.add('fr-book-cover-placeholder');"></a>
      <div class="fr-book-info">
        <h4 class="fr-book-title">
