...
page_heading_title: Why lanterns can look like distress flares
source_count: 26
infographic_count: 3
planned_sections:
...
image: /assets/images/ifos_-_causes_of_UFO_3ed238_sky_lanterns_eacec5_lantern_flare_confus_d0b412-Illustration-1-social.jpg
---
...
* **Slow descent and fading:** As the fuel source weakens, a lantern may dim gradually, resembling the final stages of a flare observed at long [range]({{ 'range/' | relative_url }}).
...
<section class="further-reading-section" data-page-toc-exclude aria-labelledby="further-reading-title">
  <div class="fr-section-shell">
    <div class="fr-section-header">
      ...
      <p class="fr-intro">Books and field guides related to Why lanterns can look like distress flares. Use these as the next step if you want deeper reading beyond the article.</p>
    </div>
    ...
    <article class="fr-book-card">
      ...
      <div class="fr-book-info">
        ...
        <p class="fr-book-desc">Provides a strong framework for distinguishing plausible explanations.</p>
    ...
    <article class="fr-book-card">
      ...
      <div class="fr-book-info">
        ...
        <p class="fr-book-desc">Relevant to mistaking one type of orange light for another.</p>
        <div class="fr-book-actions">
    ...
    <article class="fr-book-card">
      ...
      <div class="fr-book-info">
        ...
        <p class="fr-book-desc">Explores how credible reports can remain contested.</p>
        <div class="fr-book-actions">
    ...
    <article class="fr-book-card">
      ...
      <div class="fr-book-info">
        ...
        <p class="fr-book-desc">Shows how to look carefully before drawing conclusions from visual clues.</p>
        <div class="fr-book-actions">
