...
page_heading_title: Blue Book's overlooked UFO data category
source_count: 38
infographic_count: 3
planned_sections:
...
image: /assets/images/ifos_-_causes_of_UFO_3ed238_insufficient_data_46f2ca_blue_book_insufficie_2e23ae-Illustration-1-social.jpg
---
...
* Photographic or [radar]({{ 'radar/' | relative_url }}) context.

Without those details, analysts could not compare the report against aircraft movements, astronomical objects, weather phenomena, balloons, or other common causes. Rather than forcing a conclusion, Blue Book often left such reports in the insufficient-data category.<span class="citation-chip-wrap"><a class="citation-chip" href="https://www.esd.whs.mil/Portals/54/Documents/FOID/Reading%20Room/UFOsandUAPs/proj_b1.pdf?ver=2017-05-22-113513-837" target="_blank" rel="noopener noreferrer nofollow" aria-label="View source: esd.whs.mil">[Defense Logistics Agency]</a><span class="citation-popover" role="note"><span class="citation-popover-source">esd.whs.mil</span><span class="citation-popover-snippet">Defense Logistics AgencyProject Blue BookThe Air Force groups its evaluations of UFO reports under three general headings: (1) identified...</span></span></span>
...
Blue Book's system reminds readers to distinguish between:<span class="citation-chip-wrap"><a class="citation-chip" href="https://prologue.blogs.archives.gov/2018/04/16/ufos-natural-explanations/" target="_blank" rel="noopener noreferrer nofollow" aria-label="View source: prologue.blogs.archives.gov">[prologue.blogs.archives.gov]</a><span class="citation-popover" role="note"><span class="citation-popover-source">prologue.blogs.archives.gov</span><span class="citation-popover-title">blue book 2</span><span class="citation-popover-snippet">Pieces of HistoryUFOs: Natural Explanations - Pieces of History16 Apr 2018 — After investigating a case, the Air Force placed it into one...</span></span></span>

* A report that remains unexplained because evidence is weak.
* A report that remains unexplained despite strong evidence.

Those are very different situations. The first tells us little about the object itself. The second may warrant closer attention. Pieces of History<span class="citation-chip-wrap"><a class="citation-chip" href="https://www.esd.whs.mil/Portals/54/Documents/FOID/Reading%20Room/UFOsandUAPs/proj_b1.pdf?ver=2017-05-22-113513-837" target="_blank" rel="noopener noreferrer nofollow" aria-label="View source: esd.whs.mil">[Defense Logistics Agency]</a><span class="citation-popover" role="note"><span class="citation-popover-source">esd.whs.mil</span><span class="citation-popover-snippet">Defense Logistics AgencyProject Blue BookThe Air Force groups its evaluations of UFO reports under three general headings: (1) identified...</span></span></span>
...
<section class="further-reading-section" data-page-toc-exclude aria-labelledby="further-reading-title">
  <div class="fr-section-shell">
    <div class="fr-section-header">
      ...
      <p class="fr-intro">Books and field guides related to Blue Book&#x27;s overlooked UFO data category. Use these as the next step if you want deeper reading beyond the article.</p>
    </div>
    ...
    <article class="fr-book-card">
      ...
      <div class="fr-book-info">
        ...
        <p class="fr-book-desc">Provides modern official-case context that pairs well with historical Blue Book material.</p>
    ...
    <article class="fr-book-card">
      ...
      <div class="fr-book-info">
        ...
        <p class="fr-book-desc">Directly addresses evidence quality, classification, and why some cases cannot be evaluated.</p>
        <div class="fr-book-actions">
    ...
    <article class="fr-book-card">
      ...
      <div class="fr-book-info">
        ...
        <p class="fr-book-desc">Connects Blue Book history with the distinction between identified and unexplained reports.</p>
        <div class="fr-book-actions">
    ...
    <article class="fr-book-card">
      ...
      <div class="fr-book-info">
        ...
        <p class="fr-book-desc">Explains official case handling and reporting categories from a Blue Book-era perspective.</p>
        <div class="fr-book-actions">
